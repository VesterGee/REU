...
/*
		cout<<"Process check on values:"<<endl;
		cout << beginning << endl;
		cout << end << endl;
		cout << length<< endl;
...
/*
	...
	*/
	...
	cout << "Main check on values from Process 1:"<< endl;
	cout << f1.return_process(0).getBeginning() << endl;
	cout << f1.return_process(0).getEnd() << endl;
	cout << f1.return_process(0).getLength() << endl;
	cout << f1.return_process(0).getRequestsGen() << endl;
	...
	cout << "Main check on values from Process 2:"<< endl;
	cout << f1.return_process(1).getBeginning() << endl;
	cout << f1.return_process(1).getEnd() << endl;
	cout << f1.return_process(1).getLength() << endl;
	cout << f1.return_process(1).getRequestsGen() << endl;
	cout << f1.return_process(1).getInterleavingGen() << endl;

	cout << "Main check on values from Process 3:"<< endl;
	cout << f1.return_process(2).getBeginning() << endl;
	cout << f1.return_process(2).getEnd() << endl;
	cout << f1.return_process(2).getLength() << endl;
	cout << f1.return_process(2).getRequestsGen() << endl;
	cout << f1.return_process(2).getInterleavingGen() << endl;

	cout << "Main check on values from Process 5:"<< endl;
	cout << f1.return_process(4).getBeginning() << endl;
	cout << f1.return_process(4).getEnd() << endl;
	cout << f1.return_process(4).getLength() << endl;
	cout << f1.return_process(4).getRequestsGen() << endl;
	cout << f1.return_process(4).getInterleavingGen() << endl;

	cout << "Main check on values from Process 6??:"<< endl;
	cout << f1.return_process(5).getBeginning() << endl;
	cout << f1.return_process(5).getEnd() << endl;
	cout << f1.return_process(5).getLength() << endl;
	cout << f1.return_process(5).getRequestsGen() << endl;
	cout << f1.return_process(5).getInterleavingGen() << endl;
